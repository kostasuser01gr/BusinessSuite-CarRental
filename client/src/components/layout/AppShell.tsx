      ...
      >
        <div className="flex h-16 shrink-0 items-center justify-between px-4 border-b border-border">
          <div className="flex items-center gap-2">
            <div
              ref={logoRef}
              className="flex h-8 w-8 items-center justify-center rounded-md bg-primary font-bold text-primary-foreground shrink-0 shadow-lg shadow-primary/20"
            >
              A
            </div>
            {(sidebarOpen || mobileMenuOpen) && (
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  data-nav-item
                  onMouseEnter={(event) =>
                    animateHoverLift(event.currentTarget, true)
                  }
                  onMouseLeave={(event) =>
                    animateHoverLift(event.currentTarget, false)
                  }
                >
                  <item.icon
                    className={cn(
        ...
        <div className="p-4 border-t border-border flex flex-col gap-2">
          ...
          {(sidebarOpen || mobileMenuOpen) && (
            <Button
              variant="ghost"
              className="w-full mt-2 justify-start text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors"
      ...
      <main className="flex flex-1 flex-col min-w-0 relative z-10">
        {!isOnline && (
          ...
          >
            ...
            <span>
              Offline Mode: Your changes are being queued and will sync when
              reconnected.
            </span>
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-border bg-background/60 backdrop-blur-md px-4 md:px-6 sticky top-0 z-30 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              onClick={() =>
                addToast("Notifications panel coming soon", "info")
              }
              title="Notifications"
            >
      ...
      {assistantOpen && (
        <>
          ...
          <aside
            ...
            className="fixed inset-y-0 right-0 z-50 flex w-80 max-w-[92vw] border-l border-border bg-card/80 backdrop-blur-xl flex-col shadow-2xl opacity-0"
          >
            <div className="flex h-16 shrink-0 items-center justify-between px-4 border-b border-border">
